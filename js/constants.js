...
const EVENT_CHANCE = 0.6; // TEMP: bird-only testing (wind forced off in startWindOrBird), matched to CAT_EVENT_CHANCE for a 50/50 split — restore to 0.30 when done
